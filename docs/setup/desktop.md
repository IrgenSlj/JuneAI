...
This file documents how to run, build, and develop the June desktop shell at
`apps/desktop/`. The shell is a Tauri 2.x wrapper around the SvelteKit build that
already powers the PWA. Current distribution direction lives in
[`docs/product/development-plan.md`](../product/development-plan.md); this file is
...
| 5. Touch + responsive hardening | Backlog — tracked in the development plan |
